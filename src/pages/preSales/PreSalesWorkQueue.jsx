...
export default function PreSalesWorkQueue() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      if (isBdActor && ['handover', 'meetings'].includes(routeMode)) {
  ...
  return (
    <div className="space-y-6">
      ...
      {isBdActor && ['handover', 'meetings'].includes(routeMode) ? <BdOpportunityWork mode={routeMode} /> :
