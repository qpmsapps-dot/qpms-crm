...
class HomeScreen extends StatefulWidget {
  const HomeScreen({
    ...
    this.onOpenAdminModules,
    this.onOpenAdminActivities,
    this.onOpenAdminBdLeads,
    this.onOpenAdminHospital,
    this.onOpenHospitalTicketing,
    this.showHospitalTicketingEntry = false,
    super.key,
  });

  final FoUser user;
  final Future<void> Function() onLogout;
  final VoidCallback? onOpenAdminModules;
  final VoidCallback? onOpenAdminActivities;
  final VoidCallback? onOpenAdminBdLeads;
  final VoidCallback? onOpenAdminHospital;
  final VoidCallback? onOpenHospitalTicketing;
  final bool showHospitalTicketingEntry;
...
class _HomeScreenState extends State<HomeScreen>
    ...
    return Scaffold(
      body: FoPage(
        children: [
          ...
          if (_showAdminQuickAccess) ...[
            _adminQuickAccessSection(),
            const SizedBox(height: 16),
          ],
  ...
  bool get _showAdminQuickAccess =>
      isAdminRole(widget.user.role) &&
      widget.onOpenAdminModules != null &&
      widget.onOpenAdminActivities != null &&
      widget.onOpenAdminBdLeads != null &&
      widget.onOpenAdminHospital != null;

  Widget _adminQuickAccessSection() {
    return FoCard(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          FoSectionTitle(
            ...
            trailing: TextButton.icon(
              onPressed: widget.onOpenAdminModules,
              ...
              return Wrap(
                ...
                children: [
                  _adminShortcut(
                    ...
                    label: 'BD Leads',
                    onTap: widget.onOpenAdminBdLeads!,
                  ),
                  _adminShortcut(
                    width: itemWidth,
                    icon: Icons.assignment_outlined,
                    label: 'Activities',
                    onTap: widget.onOpenAdminActivities!,
                  ),
                  _adminShortcut(
                    width: itemWidth,
                    icon: Icons.local_hospital_outlined,
                    label: 'Hospital',
                    onTap: widget.onOpenAdminHospital!,
                  ),
                  _adminShortcut(
                    width: itemWidth,
                    icon: Icons.apps_rounded,
                    label: 'More Modules',
                    onTap: widget.onOpenAdminModules!,
                  ),
                ],
              );
            },
    ...
    return SizedBox(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              Icon(icon, color: qpmsBlue, size: 22),
  ...
  bool get _showHospitalTicketingEntry =>
      ...
      widget.showHospitalTicketingEntry;
