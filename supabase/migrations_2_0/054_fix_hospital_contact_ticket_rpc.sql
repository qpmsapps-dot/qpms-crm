-- Fix NIMS registered-contact ticket creation for the current hospital_tickets schema.
-- Migration 053 passed p_floor_id/p_department_id through to the RPC, but
-- hospital_tickets stores hierarchy snapshots rather than floor_id/department_id columns.
